...
export default function Banner() {
  ...
  const linkTo = "https://twitter.com/search?q=%23GazaGenocide";
  ...
  return (
    <div
      className={`sticky top-0 isolate z-50 flex items-center overflow-hidden ${isDarkMode ? "bg-gray-600/70" : "bg-gray-50/70"
    ...
    >
      ...
      <p
        className={`mx-auto text-sm ${isDarkMode ? "text-gray-300" : "text-gray-800"
          } sm:leading-6`}
      >
        <a href={linkTo} target="_blank" rel="noreferrer">
        <div className="flex flex-wrap flex-row place-items-center">
       <div><PS style={{width: 20,height: 20,}}></PS></div> 
       <div><strong className="font-semibold"> { title } </strong></div>
       <Circle />
        {description}
       </div>
